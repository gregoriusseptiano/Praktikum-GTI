...
float drop = 0, bring = 0, grab = 0;

const GLfloat light_ambient[] = { 0.5f, 0.5f, 0.5f, 0.0f };
const GLfloat light_diffuse[] = { 1.0f, 1.0f, 1.0f, 1.0f };
const GLfloat light_specular[] = { 1.0f, 1.0f, 1.0f, 1.0f };
const GLfloat light_position[] = { 20.0f, 10.0f, 1.0f, 0.0f };
...
void Balok(float panjang, float lebar, float tinggi)
{
    ...
    // atas
    glBegin(GL_QUADS);
    glTexCoord2f(0.0f, 0.0f); glVertex3f(-p, 0, -1);
    glTexCoord2f(0.0f, 1.0f); glVertex3f(p, 0, -1);
    glTexCoord2f(1.0f, 0.0f); glVertex3f(p, 0, 1);
    glTexCoord2f(1.0f, 1.0f); glVertex3f(-p, 0, 1);
    glEnd();
    // bawah
    glBegin(GL_QUADS);
    glTexCoord2f(0.0f, 0.0f); glVertex3f(-p, -t * 2, -1);
    glTexCoord2f(0.0f, 1.0f); glVertex3f(p, -t * 2, -1);
    glTexCoord2f(1.0f, 0.0f); glVertex3f(p, -t * 2, 1);
    glTexCoord2f(1.0f, 1.0f); glVertex3f(-p, -t * 2, 1);
    glEnd();
    // kanan
    glBegin(GL_QUADS);
    glTexCoord2f(0.0f, 0.0f); glVertex3f(-p, -t * 2, -1);
...
void pengubahTangan() {
    if (posXBadan != 4) {
        //kondisi jika tubuh menyentuh kotak bawah
        hit = 0;
    } else {
        hit = 1;
    }
    if (hit == 1 && grab == 1){
        //kondisi jika menyentuh kotak dan ada perintah mengambil
        bring = 1;
    }
    //memegang
    if (gerakTangan == 1) {
        //kondisi pelebarkan tangan samping
        if (rotTangan1 >= -90) {
            rotTangan1 -= 0.1;
        }
        if (rotTangan1 < -90) {
    ...
    if (gerakTangan == 2) {
        //kondisi merapatkan tangan depan
        if (rotTangan2 >= -90) {
            rotTangan2 -= 0.1;
        }
    ...
    if (gerakTangan == 4){
        //kondisi merapatkan tangan samping
        if (rotTangan1 <= 0) {
            rotTangan1 += 0.1;
        }
        if (rotTangan1 > 0) {
